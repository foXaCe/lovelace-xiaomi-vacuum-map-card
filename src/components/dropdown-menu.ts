            ...
            >
                <div class="dropdown-menu-button clickable" slot="trigger" alt="bottom align">
                    ...
                    ${conditional(
                        ...
                        () => html` <div class="dropdown-menu-button-text">${currentValue.name}</div>`
                    )}
                </div>
                ${this.values.map(
                    (mode, index) =>
                        ...
                        >
                            <div class="dropdown-menu-entry clickable ${this.currentIndex === index ? "selected" : ""}">
                                <div
                                    class="dropdown-menu-entry-button-wrapper ${index === 0 ? "first" : ""} ${index ===
                                    this.values.length - 1
                                        ? "last"
                                        : ""} ${this.currentIndex === index ? "selected" : ""}"
                                >
                                    <paper-button
                                        class="dropdown-menu-entry-button ${this.currentIndex === index
                                            ? "selected"
                                            : ""}"
                                    >
