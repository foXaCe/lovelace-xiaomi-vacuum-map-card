...
// Tuesday, August 10
export const formatDateWeekdayDay = (dateObj: Date, locale: FrontendLocaleDataFixed): string =>
    formatDateWeekdayDayMem(locale).format(dateObj);

const formatDateWeekdayDayMem = (locale: FrontendLocaleDataFixed) =>
...
const formatDateNumericMem = (locale: FrontendLocaleDataFixed) =>
    new Intl.DateTimeFormat(locale.language, {
        year: "numeric",
        month: "numeric",
        day: "numeric",
...
const formatDateShortMem = (locale: FrontendLocaleDataFixed) =>
    new Intl.DateTimeFormat(locale.language, {
        day: "numeric",
        month: "short",
    });
...
// August 2021
export const formatDateMonthYear = (dateObj: Date, locale: FrontendLocaleDataFixed): string =>
    formatDateMonthYearMem(locale).format(dateObj);

const formatDateMonthYearMem = (locale: FrontendLocaleDataFixed) =>
    new Intl.DateTimeFormat(locale.language, {
        month: "long",
        year: "numeric",
    });
...
const formatDateMonthMem = (locale: FrontendLocaleDataFixed) =>
    new Intl.DateTimeFormat(locale.language, {
        month: "long",
    });
...
const formatDateYearMem = (locale: FrontendLocaleDataFixed) =>
    new Intl.DateTimeFormat(locale.language, {
        year: "numeric",
    });
...
const formatDateWeekdayMem = (locale: FrontendLocaleDataFixed) =>
    new Intl.DateTimeFormat(locale.language, {
        weekday: "long",
    });
