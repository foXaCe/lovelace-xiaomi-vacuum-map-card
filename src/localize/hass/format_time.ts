...
// 9:15:24 PM || 21:15:24
export const formatTimeWithSeconds = (dateObj: Date, locale: FrontendLocaleDataFixed): string =>
...
// 21:15
export const formatTime24h = (dateObj: Date): string => formatTime24hMem().format(dateObj);
